#ifndef SUIXINGCHENBUF_H
#define SUIXINGCHENBUF_H
...
class SuiXingChenBuf : public Buff
{
public:
    SuiXingChenBuf(Player &player);
    SuiXingChenBuf(const SuiXingChenBuf &buff);
    ~SuiXingChenBuf();
    SuiXingChenBuf *Clone();
    SuiXingChenBuf& operator=(const SuiXingChenBuf &buff);
