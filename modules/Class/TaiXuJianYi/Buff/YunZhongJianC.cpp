...
int YunZhongJianC::s_lastFrames = 8 * 16;
int YunZhongJianC::s_intervalFrames = 16;
...
void YunZhongJianC::Cast(Player &player,
...
void YunZhongJianC::Refresh(Player &player)
{
...
Stats::TableResult YunZhongJianC::GetRollResult(Player &player, Target &target)
{
...
Stats::DamageStats YunZhongJianC::GetDamage(Player &player, Target &target, Stats::TableResult tableResult)
{
...
void YunZhongJianC::RecordStats(Player &player,
                                Target &target,
                                Stats::ThreadStats &threadStats,
                                Stats::SIM_MODE &simMode,
...
void YunZhongJianC::SubEffect(Player &player, TargetList &targetList, Stats::ThreadStats threadStats, Stats::SIM_MODE simMode, Stats::TableResult tableResult)
{
