#ifndef RENJIANHEYITBUF_H
#define RENJIANHEYITBUF_H
...
class RenJianHeYiTBuf : public Buff
{
public:
    RenJianHeYiTBuf(Player &player, Target &target);
    RenJianHeYiTBuf(const RenJianHeYiTBuf &buff);
    ~RenJianHeYiTBuf();
    RenJianHeYiTBuf *Clone();
    RenJianHeYiTBuf& operator=(const RenJianHeYiTBuf &buff);
