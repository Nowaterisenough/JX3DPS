...
void JX3DPS::MoWen::Skill::Gong::ChangeBian(bool b)
{
    if (b) {
...
void JX3DPS::MoWen::Skill::Zhi::ChangeBian(bool b)
{
    if (b) {
        m_id   = SKILL_BIAN_ZHI;
        m_name = "变徵";
...
void JX3DPS::MoWen::Skill::GaoShanLiuShui::Cast()
{
    ...
    { // 高山主动
        ...
        *m_globalCooldownCurrent = 50 * 16;
        ...
        static_cast<Zhi *>(m_player->skills[SKILL_ZHI])->ChangeBian(true);
        static_cast<Gong *>(m_player->skills[SKILL_GONG])->ChangeBian(true);
    }
}
...
void JX3DPS::MoWen::Skill::YangChunBaiXue::Cast()
{
    ...
    {        // 阳春主动
        ...
        static_cast<Zhi *>(m_player->skills[SKILL_ZHI])->ChangeBian(false);
        static_cast<Gong *>(m_player->skills[SKILL_GONG])->ChangeBian(false);
    }
}
