...
if(NOT BUILD_SHARED_LIBS)
    if(MSVC)
        set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /utf-8 /MT /GR- /GS- /GL /Ot /Oi /Ob2 /fp:fast /Qpar /Qvec-report:2")
        set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} /utf-8 /MTd")
    endif()
else()
    if(MSVC)
        set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /utf-8 /MD /GR- /GS- /GL /Ot /Oi /Ob2 /fp:fast /Qpar /Qvec-report:2")
