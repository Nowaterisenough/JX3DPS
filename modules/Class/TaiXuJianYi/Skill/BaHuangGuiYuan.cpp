 ...
 * @Update      : NoWats
 * @LastTime    : 2022-02-04 13:17:00
 * @FilePath    : \JX3DPS\modules\Class\TaiXuJianYi\Skill\BaHuangGuiYuan.cpp
 */
...
BaHuangGuiYuan::BaHuangGuiYuan(Player *player) : Skill(player)
{
    InitBaseParams();
    InitDamageParams();
}
...
void BaHuangGuiYuan::InitDamageParams()
{
    ...
    m_damageParamVecMap[m_subNameVec[2]].push_back(
        Stats::DamageParam((97 + 107) / 8, 512, 1.2688 / 4));
    m_damageParamVecMap[m_subNameVec[2]].push_back(
        Stats::DamageParam((171 + 188) / 8, 512, 1.4003 / 4));
    m_damageParamVecMap[m_subNameVec[2]].push_back(
        Stats::DamageParam((245 + 270) / 8, 512, 1.5317 / 4));
    m_damageParamVecMap[m_subNameVec[2]].push_back(
        Stats::DamageParam((319 + 352) / 8, 512, 1.6631 / 4));
    m_damageParamVecMap[m_subNameVec[2]].push_back(
        Stats::DamageParam((394 + 433) / 8, 512, 1.7944 / 4));
    m_damageParamVecMap[m_subNameVec[2]].push_back(
        Stats::DamageParam((468 + 515) / 8, 512, 1.9258 / 4));
    m_damageParamVecMap[m_subNameVec[2]].push_back(
        Stats::DamageParam((542 + 597) / 8, 512, 2.0572 / 4));
    m_damageParamVecMap[m_subNameVec[2]].push_back(
        Stats::DamageParam((616 + 678) / 8, 512, 2.1886 / 4));
    m_damageParamVecMap[m_subNameVec[2]].push_back(
        Stats::DamageParam((690 + 760) / 8, 512, 2.3200 / 4));
}
...
Stats::DamageStats
BaHuangGuiYuan::GetDamage(Player &player, Target &target, Stats::TableResult tableResult)
{
    ...
    int fixedDamage = static_cast<int>(
        m_damageParamVecMap[m_subNameVec[0]][static_cast<unsigned>(10 - target.GetLifeDecPercent())]
            .fixedDamage *
        percentAdd);
    int weaponDamage = static_cast<int>(
        (m_damageParamVecMap[m_subNameVec[0]][static_cast<unsigned>(10 - target.GetLifeDecPercent())]
             .weaponDamageBinPercent >>
         10) *
        player.GetWeaponAttack() * percentAdd);
    int attackDamage = static_cast<int>(
        m_damageParamVecMap[m_subNameVec[0]][static_cast<unsigned>(10 - target.GetLifeDecPercent())]
            .attackDamagePercent *
                                 ...
                                 Stats::TableResult  tableResult)
{
    ...
    case Stats::SIM_MODE::DEFAULT:
        ...
        threadStats.threadDamageStats[m_id]
            .second[target.GetId()][m_subNameVec[0]][10 - target.GetLifeDecPercent()]
            .second[tableResult]
            .first++;
        threadStats.threadDamageStats[m_id]
            .second[target.GetId()][m_subNameVec[0]][10 - target.GetLifeDecPercent()]
    ...
    if (tableResult != Stats::TableResult::MISS) {
        ...
        if (static_cast<Buff *>(targetList.front()->m_buffMap[TBUF_DIE_REN])->IsExist()) {
            if (static_cast<TaiXuJianYi *>(&player)->m_talentHeGuang) {
                Stats::TableResult tableResultHeGuang =
                    GetRollResultHeGuang(player, *targetList.front());
                RecordStatsHeGuang(player, *targetList.front(), threadStats, simMode, tableResultHeGuang);
            }
            if (targetList.front()->GetLifeDecPercent() < 5 &&
                static_cast<TaiXuJianYi *>(&player)->m_talentQieYu)
            {
...
Stats::DamageStats
BaHuangGuiYuan::GetDamage2(Player &player, Target &target, Stats::TableResult tableResult)
{
    double percentAdd = (1024 + m_skillDamageBinPercentAdd) / 1024.0 *
                        (1 + player.GetPhysicsOvercomePercent()) *
                        (1 + target.GetDamagePercentAdd()) * (1 - target.GetPhysicsResistPercent());
    int fixedDamage = static_cast<int>(
        m_damageParamVecMap[m_subNameVec[1]][static_cast<unsigned>(10 - target.GetLifeDecPercent())]
            .fixedDamage *
        percentAdd);
    int weaponDamage = static_cast<int>(
        (m_damageParamVecMap[m_subNameVec[1]][static_cast<unsigned>(10 - target.GetLifeDecPercent())]
                                  ...
                                  Stats::TableResult  tableResult)
{
    ...
    case Stats::SIM_MODE::DEFAULT:
        damageStats = GetDamage(player, target, tableResult);
        threadStats.threadDamageStats[m_id]
            .second[target.GetId()][m_subNameVec[1]][10 - target.GetLifeDecPercent()]
            .second[tableResult]
            .first++;
        threadStats.threadDamageStats[m_id]
            .second[target.GetId()][m_subNameVec[1]][10 - target.GetLifeDecPercent()]
...
Stats::DamageStats
BaHuangGuiYuan::GetDamageHeGuang(Player &player, Target &target, Stats::TableResult tableResult)
{
    double percentAdd = (1024 + m_skillDamageBinPercentAdd) / 1024.0 *
                        (1 + player.GetPhysicsOvercomePercent()) *
                        (1 + target.GetDamagePercentAdd()) * (1 - target.GetPhysicsResistPercent());
    int fixedDamage = static_cast<int>(
        m_damageParamVecMap[m_subNameVec[2]][static_cast<unsigned>(10 - target.GetLifeDecPercent())]
            .fixedDamage *
        percentAdd);
    int weaponDamage = static_cast<int>(
        (m_damageParamVecMap[m_subNameVec[2]][static_cast<unsigned>(10 - target.GetLifeDecPercent())]
                                        ...
                                        Stats::TableResult  tableResult)
{
    ...
    case Stats::SIM_MODE::DEFAULT:
        damageStats = GetDamage(player, target, tableResult);
        threadStats.threadDamageStats[m_id]
            .second[target.GetId()][m_subNameVec[2]][10 - target.GetLifeDecPercent()]
            .second[tableResult]
            .first++;
        threadStats.threadDamageStats[m_id]
            .second[target.GetId()][m_subNameVec[2]][10 - target.GetLifeDecPercent()]
