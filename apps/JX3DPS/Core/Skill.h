 ...
 * Author: 难为水
 * -----
 * Last Modified: 2023-07-03 03:22:50
 * Modified By: 难为水
 * -----
 * HISTORY:
 * Date      	By     	Comments
...
protected:
    ...
    /* 技能会心加成 */
    PctInt_t m_skillCriticalStrikePercentAdd = 0;

    /* 技能会心效果加成 */
    PctInt_t m_skillCriticalStrikePowerPercentAdd = 0;

    /* 技能伤害加成 */
    PctInt_t m_skillDamageBinPercentAdd = 0;
