...
void YunZhongJianJ::Cast(TargetsMap &targetsMap, Stats &stats)
{
...
void YunZhongJianJ::Clean(TargetsMap &targetsMap, Stats &stats, int param)
{
    m_effectCount = 0;
...
void YunZhongJianJ::SubEffect(TargetsMap &targetsMap, Stats &stats)
{
