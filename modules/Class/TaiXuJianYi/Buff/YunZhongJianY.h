#ifndef YUNZHONGJIANY_H
#define YUNZHONGJIANY_H
...
class YunZhongJianY : public Buff
{
public:
    YunZhongJianY(Player &player);
    YunZhongJianY(const YunZhongJianY &buff);
    ~YunZhongJianY();
    YunZhongJianY *Clone();
