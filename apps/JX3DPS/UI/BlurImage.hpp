...
template <class T>
inline static void qt_memrotate270_tiled_unpacked(const T *src, int w, int h, int sstride, T *dest, int dstride)
{
...
template <class T>
inline static void qt_memrotate270_template(const T *src, int srcWidth, int srcHeight, int srcStride, T *dest, int dstStride)
{
    // #if Q_BYTE_ORDER == Q_LITTLE_ENDIAN
    //     // packed algorithm assumes little endian and that sizeof(quint32)/sizeof(T) is an
    //     integer if (sizeof(quint32) % sizeof(T) == 0)
...
template <class T>
inline static void qt_memrotate90_tiled_unpacked(const T *src, int w, int h, int sstride, T *dest, int dstride)
{
    const int numTilesX = (w + tileSize - 1) / tileSize;
    const int numTilesY = (h + tileSize - 1) / tileSize;
...
template <class T>
inline static void qt_memrotate90_template(const T *src, int srcWidth, int srcHeight, int srcStride, T *dest, int dstStride)
{
    // #if Q_BYTE_ORDER == Q_LITTLE_ENDIAN
    //     // packed algorithm assumes little endian and that sizeof(quint32)/sizeof(T) is an
    //     integer if (sizeof(quint32) % sizeof(T) == 0)
