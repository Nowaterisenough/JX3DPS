...
{
    return Roll(m_player->GetAttr().GetPhysicsCriticalStrikePercent() + m_skillCriticalStrikePercentAdd);
}

Damage Skill::GetPhysicsDamage(const Target &target, const TableRes tableRes, const std::string &subName, const int level) const
{
    Pct_t damagePercent = ((CONST_BIN_PCT + m_skillDamageBinPercentAdd) / static_cast<double>(CONST_BIN_PCT)) *
    ...
    int attackDamage = static_cast<int>(m_damageParams.at(subName)[level].attackDamagePercent * m_player->GetAttr().GetPhysicsAttack() * damagePercent);
    return Damage(GET_FINAL_DAMAGE(fixedDamage, tableRes, (m_player->GetAttr().GetPhysicsCriticalStrikePowerPercent() + m_skillCriticalStrikePowerPercentAdd)),
                  GET_FINAL_DAMAGE(weaponDamage, tableRes, (m_player->GetAttr().GetPhysicsCriticalStrikePowerPercent() + m_skillCriticalStrikePowerPercentAdd)),
                  GET_FINAL_DAMAGE(attackDamage, tableRes, (m_player->GetAttr().GetPhysicsCriticalStrikePowerPercent() + m_skillCriticalStrikePowerPercentAdd)));
}

void Skill::UpdatePhysicsStats(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{
...
{
    return Roll(m_player->GetAttr().GetMagicCriticalStrikePercent() + m_skillCriticalStrikePercentAdd);
}

Damage Skill::GetMagicDamage(const Target &target, const TableRes tableRes, const std::string &subName, const int level) const
{
    Pct_t damagePercent = ((CONST_BIN_PCT + m_skillDamageBinPercentAdd) / static_cast<double>(CONST_BIN_PCT)) *
                          (1 + m_player->GetAttr().GetMagicOvercomePercent()) *
                          (1 + target.GetDamageAddPercent()) *
                          (1 - target.GetMagicResistPercent());
    int fixedDamage = static_cast<int>(m_damageParams.at(subName)[level].fixedDamage * damagePercent);
    int weaponDamage = static_cast<int>((m_damageParams.at(subName)[level].weaponDamageBinPercent >> 10) * m_player->GetAttr().GetWeaponAttack() * damagePercent);
    int attackDamage = static_cast<int>(m_damageParams.at(subName)[level].attackDamagePercent * m_player->GetAttr().GetMagicAttack() * damagePercent);
    return Damage(GET_FINAL_DAMAGE(fixedDamage, tableRes, (m_player->GetAttr().GetMagicCriticalStrikePowerPercent() + m_skillCriticalStrikePowerPercentAdd)),
                  GET_FINAL_DAMAGE(weaponDamage, tableRes, (m_player->GetAttr().GetMagicCriticalStrikePowerPercent() + m_skillCriticalStrikePowerPercentAdd)),
                  GET_FINAL_DAMAGE(attackDamage, tableRes, (m_player->GetAttr().GetMagicCriticalStrikePowerPercent() + m_skillCriticalStrikePowerPercentAdd)));
}

void Skill::UpdateMagicStats(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{
...
void Skill::StatsNoneDetail(const Target &target, const TableRes tableRes, const std::string &subName, const int level, const Damage &damage, Stats &stats) const
{

}

void Skill::StatsDetail(const Target &target, const TableRes tableRes, const std::string &subName, const int level, const Damage &damage, Stats &stats) const
{
...
void Skill::StatsNoneBonus(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{

}

void Skill::StatsPhysicsWeaponAttackBonus(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{
...
void Skill::StatsMagicWeaponAttackBonus(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{
    m_player->GetAttr().AddWeaponAttack(g_settings.bonusSets[AttrType::WEAPON_ATTACK]->value);
    Damage damage = GetMagicDamage(target, tableRes, subName, level);
    stats.bonusStats[AttrType::WEAPON_ATTACK] += damage.SumDamage();
...
void Skill::StatsPhysicsAttackBaseBonus(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{
...
void Skill::StatsMagicAttackBaseBonus(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{
...
void Skill::StatsPhysicsCriticalStrikePowerBonus(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{
...
void Skill::StatsMagicCriticalStrikePowerBonus(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{
...
void Skill::StatsPhysicsOvercomeBaseBonus(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{
...
void Skill::StatsMagicOvercomeBaseBonus(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{
...
void Skill::StatsPhysicsStrainBonus(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{
...
void Skill::StatsMagicStrainBonus(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{
    m_player->GetAttr().AddStrain(g_settings.bonusSets[AttrType::STRAIN]->value);
    Damage damage = GetMagicDamage(target, tableRes, subName, level);
    stats.bonusStats[AttrType::STRAIN] += damage.SumDamage();
...
void Skill::StatsPhysicsSurplusBonus(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{
...
void Skill::StatsMagicSurplusBonus(const Target &target, const TableRes tableRes, const std::string &subName, const int level, Stats &stats) const
{
    m_player->GetAttr().AddSurplusBase(g_settings.bonusSets[AttrType::SURPLUS]->value);
    Damage damage = GetMagicDamage(target, tableRes, subName, level);
    stats.bonusStats[AttrType::SURPLUS] += damage.SumDamage();
...
{
    int rand = RandBetween(s_delayMin, s_delayMax);
    Frame_t delayFrames = rand / CONST_DELAY;
    *m_publicCooldown = s_publicCooldown * m_player->GetAttr().GetHastePercent() + delayFrames;
}
