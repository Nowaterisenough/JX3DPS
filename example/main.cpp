...
public:
    ...
    bool Evaluate() const override noexcept { return _proxy->Evaluate(); }
};
...
public:
    ...
    bool Evaluate() const override noexcept { return true; }

    std::string GetAction() const override noexcept { return _action; }
};
...
public:
    ...
    bool Evaluate() override noexcept const
    {
