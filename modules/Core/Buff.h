...
#else
    TableRes Buff::Roll(const Pct_t    playerHitPercent,
                        const Pct_t    playerCriticalStrikePercent,
                        const Pct_t    playerStrainPercent,
                        const Pct_t    targetMissPercent,
                        const Pct_t    targetSightPercent,
