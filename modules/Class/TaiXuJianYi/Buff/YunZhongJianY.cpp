...
void YunZhongJianY::Cast(TargetsMap &targetsMap, Stats &stats)
{
...
void YunZhongJianY::Clean(TargetsMap &targetsMap, Stats &stats, int param)
{
    m_effectCount = 0;
...
void YunZhongJianY::SubEffect(TargetsMap &targetsMap, Stats &stats)
{
