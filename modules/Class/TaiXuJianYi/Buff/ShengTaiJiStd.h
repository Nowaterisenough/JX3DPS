#ifndef SHENGTAIJISTD_H
#define SHENGTAIJISTD_H
...
class ShengTaiJiStd : public Buff
{
public:
    ShengTaiJiStd(Player &player);
    ShengTaiJiStd(const ShengTaiJiStd &buff);
    ~ShengTaiJiStd();
    ShengTaiJiStd *Clone();
    ShengTaiJiStd& operator=(const ShengTaiJiStd &buff);
